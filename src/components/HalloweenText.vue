<template>
  <div class="flex flex-col p-10 mt-60 md:mt-80 text-white">
    ...
    <p class="text-base-halloween">
      ...
      sacred (it also may have something to do with the fact that walking under
      a leaning ladder tends to be fairly unsafe).
    </p>
    ...
    <h2 class="text-9xl mb-40% font-Creepster">Spooky Halloween !</h2>
  </div>
</template>
